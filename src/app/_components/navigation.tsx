...
const MobileNav = () => {
    ...
    return (
        <nav className="h-[80px] fixed bg-white w-full z-50 lg:hidden flex shadow">
                ...
                <div className="w-[80px] relative h-[80px]">
                    <Link href="/">
                        <Image
                            src="/logo.png"
                            alt="Logo Inready Workgroup"
                            className="mx-auto h-[80px] hover:text-black lg:mx-0 w-10 relative"
                            sizes="100%"
                            fill
                        />
                    </Link>
            ...
            <div
                className={`h-[calc(100dvh-80px)] z-50 absolute left-0 flex w-full flex-col justify-center-safe gap-4 bg-white text-left shadow transition-all duration-500 lg:hidden ${show ? `opacity-100 top-[80px] flex` : `opacity-0 top-[70px] hidden`}`}
            >
                {/* <AnimatePresence> */}
