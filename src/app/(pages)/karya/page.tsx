            ...
            <div className="my-24 flex flex-col items-center text-center">
                ...
                >
                    <div className="relative flex w-full justify-center">
                        ...
                        <DropdownMenu.Root>
                            <DropdownMenu.Trigger className="group flex mr-0 ml-auto items-center bg-primary/20 rounded-md px-5 gap-1 py-2 text-greyCol font-medium text-xs cursor-pointer">
                                Urutkan
                                <ChevronDownIcon className="transition-transform transform text-[#969696] group-data-[state=open]:-rotate-180" />
                            </DropdownMenu.Trigger>
                            <DropdownMenu.Content className="relative z-10 mt-4 flex animate-dropDownOut flex-col rounded-[7px] bg-white shadow outline-1 outline-[#D1D5DB] data-[state=open]:animate-dropDown text-xs overflow-hidden">
                                <DropdownMenu.Item
                ...
                <ReactPaginate
                    ...
                    pageCount={Math.ceil(
                        karya?.meta.total_item / karya?.meta.perpage,
                    )}
                    breakLabel="..."
                    previousLabel="<"
                    nextLabel=">"
